...
import com.spring.professional.exam.tutorial.module01.question24.definitions.configuration.level.AopplicationConfiguration;
...
public class Runner {
	...
	public static void main(String[] args) {
		...
		context.register(AopplicationConfiguration.class);
		context.refresh();
