...
public class SpringBean1 {
	...
	public String toString() {
		return "SpringBean1 [staticMethodExecutionResult=" + staticMethodExecutionResult + ", staticValueFetchResult="
				+ staticValueFetchResult + ", propertyValue=" + propertyValue + ", methodValue=" + methodValue
				+ ", appFileProperty=" + appFileProperty + ", appVmProperty=" + appVmProperty + ", javaHome=" + javaHome
				+ "]";
	}
